        ...
        <!--<form id="itemcheac">-->
            <div class="je-form-item">
                <div class="je-w33 je-dib">
                    ...
                    <div class="je-inputbox">
                        <input type="text" name="title" autocomplete="off" placeholder="请输入权限名" class="je-input" id="auth_name" value="<?=$auth_name?>">
                    </div>
                </div>
            </div>
            ...
            <div class="je-form-item">
                <div class="je-w33 je-dib">
                    ...
                    <div class="je-inputbox">
                        <input type="text" name="title" autocomplete="off" placeholder="请输入函数名" class="je-input" id="auth_func" value="<?=$auth_func?>">
                    </div>
                </div>
            </div>
...
$("#btnIframe").on('click', function(){
	...
	$.post('<?=site_url('admin/system/mod_auth')?>', data, function(res){
			if(res.code == 200){
