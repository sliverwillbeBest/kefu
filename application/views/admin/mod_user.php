        ...
        <!--<form id="itemcheac">-->
            <div class="je-form-item">
                <div class="je-w33 je-dib">
                    ...
                    <div class="je-inputbox">
                        <input type="text" name="title" autocomplete="off" placeholder="请输入账号" class="je-input" id="username" value="<?=$username?>">
                    </div>
                </div>
            </div>
            <div class="je-form-item">
            ...
            <div class="je-form-item">
                <div class="je-w33 je-dib">
                    ...
                    <div class="je-inputbox">
                        <input type="text" name="title" autocomplete="off" placeholder="请输入姓名" class="je-input" id="real_name" value="<?=$real_name?>">
                    </div>
                </div>
            </div>
...
$("option[value='<?=$role_id?>']").attr('selected', 'selected');
...
$("#btnIframe").on('click', function(){
	...
	$.post('<?=site_url('admin/system/mod_user')?>', data, function(res){
			if(res.code == 200){
